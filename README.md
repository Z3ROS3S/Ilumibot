<h2 align="centre">🎶 Ilumi Music Bot 🎶</h2>

### Ilumi Music is a telegram bot project that's allow you to play music on telegram voice chat group.
...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/OrdinaryHumans404/Ilumibot)

## Railway Deployment 🚄
For deployment on railway you can see the full of [Necessary Variables Here](https://github.com/OrdinaryHumans404/Ilumibot/blob/main/example.env), make sure you fill all of it.

[![Deploy+on+Railway](https://railway.app/button.svg)](https://railway.app/new/template?template=https://github.com/OrdinaryHumans404/Ilumibot&envs=SESSION_NAME,BOT_TOKEN,BOT_USERNAME,BOT_NAME,GROUP_SUPPORT,ASSISTANT_NAME,OWNER_NAME,OWNER_ID,DATABASE_URL,LOG_CHANNEL,BROADCAST_AS_COPY,BG_IMAGE,UPDATES_CHANNEL,API_ID,API_HASH,PMPERMIT,SUDO_USERS,DURATION_LIMIT,THUMB_IMG)
...
- `npm i -g npm`
- `git clone https://github.com/OrdinaryHumans404/Ilumibot` # Clone your repo.
- `cd CBMusicBot`
